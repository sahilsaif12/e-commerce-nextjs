"use client"
import { abc, clearCart } from '@/features/cartSlice';
...
function page() {
  ...
  return (
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-sm w-full text-center">
        ...
        {/* <Link href={'/'} class="mt-6 bg-black text-white dark:bg-gray-300  dark:text-black font-semibold py-2 px-4 rounded-lg w-full hover:bg-gray-800 dark:hover:bg-gray-300">
